...
C.add,t.success=t.done,t.error=t.fail,m.url=((a||m.url||X)+"").replace(Lc,"").replace(Oc,W[1]+"//"),m.type=b.method||b.type||m.method||m.type,m.dataTypes=c.trim(m.dataType||"*").toLowerCase().match(H)||[""],null==m.crossDomain&&(e=Vb.exec(m.url.toLowerCase()),m.crossDomain=!(!e||e[1]===W[1]&&e[2]===W[2]&&(e[3]||("https:"===e[1]?"80":"443"))===(W[3]||("https:"===W[1]?"80":"443")))),m.data&&m.processData&&"string"!=typeof m.data&&(m.data=c.param(m.data,m.traditional)),zb(Wb,m,b,t),2===N)return t;(l=m.global)&&
