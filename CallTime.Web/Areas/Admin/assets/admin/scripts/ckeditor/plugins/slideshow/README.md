...
look at the [documentation](https://devlabnet.eu/softdev/slideshow/index.php) for more information.**
...
following location : https://adgallery.codeplex.com, and with "FancyBox" java program available at the
following location : https://fancybox.net/.
...
Demo
-------------------------
[View the live demo]( https://devlabnet.eu/softdev/slideshow/demo.php ).
...
Thanks to [CKeditor] [1] and [ad-gallery] [2] and [fancybox] [3] people for their good work.
  ...
  [1]: https://ckeditor.com              "CKeditor"
  [2]: https://adgallery.codeplex.com    "ad-gallery"
  [3]: https://fancybox.net/             "fancybox"
